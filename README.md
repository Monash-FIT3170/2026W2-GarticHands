...
- **[`GarticHands/USER_GUIDE.md`](GarticHands/USER_GUIDE.md)** — new-player guide (host, join, gestures, settings, troubleshooting).
- **[`GarticHands/TESTING_GUIDE.md`](GarticHands/TESTING_GUIDE.md)** — how to run every suite, manual test matrix, defect template.
