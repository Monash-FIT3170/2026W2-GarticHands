...
export function drawLandmarks(ctx: CanvasRenderingContext2D, landmarks: HandLandmark[]): void {
  ctx.fillStyle = 'red';
...
export function drawConnections(ctx: CanvasRenderingContext2D, landmarks: HandLandmark[]): void {
