...
const variantClasses: Record<CardVariant, string> = {
  ...
  hero: 'bg-[#559490] rounded-3xl px-10 py-8 flex flex-col items-center gap-5 w-full max-w-sm shadow-lg',
  glass: 'relative w-full max-w-sm mx-4 bg-white/[0.07] border border-white/[0.14] rounded-2xl p-7',
};
